...
public class MostrarInfoHuesoCraneo : MonoBehaviour
{
    private MenuCraneoController menu;
    ...
    {
        menu = FindObjectOfType<MenuCraneoController>();
        if (menu == null)
        {
            Debug.LogError("[MostrarInfoHuesoCraneo] No se encontró MenuCraneoController en la escena.");
            return;
        }
