...
public class MostrarInfoHuesoBrazo : MonoBehaviour
{
    private MenuBrazoController menu;
    ...
    {
        menu = FindObjectOfType<MenuBrazoController>();
        if (menu == null)
        {
            Debug.LogError("[MostrarInfoHuesoBrazo] No se encontró MenuBrazoController en la escena.");
            return;
        }
