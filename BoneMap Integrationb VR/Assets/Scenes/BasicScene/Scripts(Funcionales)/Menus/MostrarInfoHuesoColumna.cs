...
public class MostrarInfoHuesoColumna : MonoBehaviour
{
    private MenuColumnaController menu;
    ...
    {
        menu = FindObjectOfType<MenuColumnaController>();
        if (menu == null)
        {
            Debug.LogError("[MostrarInfoHuesoColumna] No se encontró MenuColumnaController en la escena.");
            return;
        }
